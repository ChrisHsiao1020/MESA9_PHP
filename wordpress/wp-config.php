 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '|P1:VuH/6!(=0b Z&w9-Z{~$m&9a<W~B7--,i<q8r|+$}.fpw Q&6L=T2ceMQ7qF');
define('SECURE_AUTH_KEY',  'b(C]Qu( KjVYbTrvnk&j3fwoC8qH b(v8Ro4ea:t3#Y.)Yw+;BzgEg<4^iU6r9F-');
define('LOGGED_IN_KEY',    '6>X/ABZeOym1?l+u!5o~MzuG$n&:SD@8<YZpY%>k5qKrK6wyy.(;T579{%N6l#M|');
define('NONCE_KEY',        'AqAEWKa3C7H$gLX:y82(M<%J4Ly3Aa=t_O{79:<& E= *k@SCLe ?t?.cU5|_H(7');
define('AUTH_SALT',        'f}#^xg4`;UG&QZ/3/LF@JidV?[X+u/>#6bfbJXf]4;>/4Ld1v~1v7Ld~VYYD/Bjw');
define('SECURE_AUTH_SALT', '#6x9`I9PcL57H:9j33*nG][Q6^[u<&7Xt}@^i[xk,7@?9p_Wy8K1Ap[/!L1$(lJv');
define('LOGGED_IN_SALT',   'KfzVgN rq,vK:~+7rgh{3}rT3412Wz.1ZG*sv,3aP{cikB7`fPy>]SHa/pk2@Cz>');
define('NONCE_SALT',       ':<WAmA`LCuSDo7aKkpty6EcE-UP6?CP`d#QEU+`+PQZB0sfp${7x+k=k%D=X:f1*');
